...
public class Register {
	...
	public void warning_msg_informing_the_user_about_the_duplicate_email_field_should_be_displayed() {
	   
		System.out.println("Warning msg informing the user about the duplicate email field should be displayed");
